                                            ...
                                            <tbody>
                                                <?php foreach ($ads as $ad) : ?>
                                                    <tr>
                                                        <td>
                                                            <div class="d-flex ">
                                                                <img src="<?= ($ad['file'] != '') ? base_url('assets/ads/' . strtolower(str_replace(' ', '_', $ad['type'])) .'/'.$ad['file']) : base_url('/assets/admin/uploads/images/client_logos/logo.png') ?>" alt="<?= $ad['title'] . 'Logo' ?>">
                                                                <div>
                                                                    <h6><?= $ad['title'] ?></h6>
                                                                    <p><?= $ad['alt'] ?></p>
                                                                </div>
