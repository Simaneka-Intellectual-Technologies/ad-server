...
<head>
    ...
    <link type="text/css" rel="stylesheet" href="<?= base_url('assets/admin/quotes/quote1/css/bootstrap.min.css') ?>">
    <link type="text/css" rel="stylesheet"
        href="<?= base_url('assets/admin/quotes/quote1/fonts/font-awesome/css/font-awesome.min.css') ?>">

    <!-- Favicon icon -->
    <link rel="shortcut icon" href="<?= base_url('assets/admin/quotes/quote1/img/favicon.ico') ?>" type="image/x-icon">
    ...
    <!-- Custom Stylesheet -->
    <link type="text/css" rel="stylesheet" href="<?= base_url('assets/admin/quotes/quote1/css/style.css') ?>">
</head>
